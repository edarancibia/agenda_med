...
public interface UserJpaRepository extends JpaRepository<User, Long> {
	...
	@Query(value = "select \n" + 
			...
			"where u.perfil = 1 and u.id = p.fk_idUsuario and p.cod_centro=:idCentro and u.estado = 1", nativeQuery = true)
	...
	@Query(value="select u.id, concat(u.a_pat,' ',u.a_mat,' ',u.nombre) as nombre, \n" + 
			...
			"where u.id = uc.idUsuario and uc.idCentro = :idCentro and u.estado = 1", nativeQuery = true)
